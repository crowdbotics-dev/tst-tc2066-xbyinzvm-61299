...
## Project Structure
    ...
    ├── tst_tc2066_xbyinzvm_61299  # Django project configurations
...
1. Clone this repo and `cd tst_tc2066_xbyinzvm_61299`
...
2. Clone this repo and `cd tst_tc2066_xbyinzvm_61299`
